...
class Isucon3App < Sinatra::Base
  ...
  get '/recent/:page' do
    ...
    memos  = mysql.xquery("SELECT * FROM memos WHERE is_private=0 and created_at <= ? ORDER BY created_at DESC, id DESC LIMIT 100 OFFSET #{page * 100}", offset["created_at"])
